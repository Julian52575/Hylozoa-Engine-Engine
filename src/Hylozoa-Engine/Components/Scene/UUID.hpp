...
namespace Hylozoa {
    ...
    *
    * This class encapsulates a unique identifier represented as a 64-bit unsigned integer.
    * The UUID can be used to uniquely identify entities or components within the engine.
    */
class UUID
{
private:
