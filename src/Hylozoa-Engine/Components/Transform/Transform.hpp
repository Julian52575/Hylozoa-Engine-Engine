...
/*
  ...
  * This component holds the position, scale, and rotation of an entity relative to its parent.
  * 
...
/*
  ...
  * This component holds the position, scale, and rotation of an entity in world space.
  * 
  * @var SDL_FPoint position
...
/*
  ...
  * @brief Internal components for managing entity relationships and transformations.
*/
namespace HylozoaInternal {
  /*
  * @struct LocalToWorld
